...
var _user$project$Data_Wallet$Wallet = F5(
	function (a, b, c, d, e) {
		return {address: a, balance: b, error: c, expandError: d, fetchingBalance: e};
	});
...
var _user$project$Update$saveWallets = function (wallets) {
	return _user$project$Update$save(
		A2(
			_elm_lang$core$List$map,
			function (wallet) {
...
var _user$project$Update$FetchBalance = function (a) {
	return {ctor: 'FetchBalance', _0: a};
};
var _user$project$Update$UpdateBalance = F2(
	function (a, b) {
		...
		switch (_p0.ctor) {
			...
			case 'Remove':
				var wallets = A2(
					...
					function (wallet) {
						return !_elm_lang$core$Native_Utils.eq(wallet.address, _p0._0);
					},
					model.wallets);
				return {
					ctor: '_Tuple2',
...
var _user$project$Update$Input = function (a) {
...
var _user$project$View$addressInput = function (newAddress) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Input),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(newAddress),
				_1: {
					ctor: '::',
...
var _user$project$View$wallet = function (wallet) {
	var baseContent = {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$actions(wallet),
				_1: {ctor: '[]'}
			}
		}
	};
